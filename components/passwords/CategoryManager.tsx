...
import { usePasswordCategories, PasswordCategory } from "@/hooks/usePasswords";
...
export const CategoryManager = ({
  ...
  const { addCategory, editCategory, removeCategory } = usePasswordCategories();
          ...
          {categories.length === 0 ? (
            ...
            <div className="grid gap-3 overflow-y-auto pr-1">
              {categories.map((category) => (
                <Card key={category._id} className="rounded-2xl border-gray-100 overflow-hidden">
