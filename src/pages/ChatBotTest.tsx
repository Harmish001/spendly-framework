    ...
    try {
      ...
      switch (testId) {
        ...
        case "expense_extraction":
          try {
            ...
            result =
              ...
              response.extractedExpenses.length > 0;
          } catch (error) {
        ...
        case "conversation_creation":
          try {
            const newConv =
              await expenseParserService.createConversation("Test Chat");
      ...
      if (result) {
        toast.success(
          `✅ ${tests.find((t) => t.id === testId)?.name} test passed!`,
        );
      } else {
        toast.error(
          `❌ ${tests.find((t) => t.id === testId)?.name} test failed!`,
        );
      }
    } catch (error) {
        ...
        <Card className="border-purple-200">
          ...
          <CardContent>
            <p className="text-gray-600 mb-4">
              Use this page to verify that your Spendly Bot setup is working
              correctly. Make sure you have configured your Gemini API key and
            ...
            <Alert className="mb-6">
              ...
              <AlertDescription>
                <div className="flex items-center justify-between">
                  <span>
                    Gemini API Key:{" "}
                    {checkApiKey() ? "✅ Configured" : "❌ Not configured"}
                  </span>
                  {!checkApiKey() && (
        ...
        <Card className="border-orange-200 bg-orange-50">
          ...
          <CardContent className="text-orange-700">
            <ol className="list-decimal list-inside space-y-2 text-sm">
              ...
              <li>
                Click the floating Spendly Bot button to start using the AI
                assistant!
              </li>
            </ol>
          </CardContent>
