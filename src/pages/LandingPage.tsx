    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-slate-200">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <Button
            className="rounded-full bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white px-6"
            onClick={handleLogin}
          >
            Login
          </Button>
      ...
      <section className="container mx-auto px-4 py-12 md:py-20">
        <div className="text-center space-y-6">
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-purple-100 to-blue-100 text-sm font-medium text-purple-700 mb-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-6">
            <Button
              size="lg"
              className="rounded-full bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white px-8 py-3 text-lg w-full sm:w-auto"
        ...
        <div className="mt-12 md:mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
            ...
            <div className="relative">
              <div className="rounded-3xl bg-gradient-to-r from-purple-600 to-blue-600 p-1">
                <div className="rounded-3xl bg-white p-4">
                  <div className="aspect-[9/16] bg-slate-100 rounded-2xl flex items-center justify-center">
                ...
                <div className="rounded-3xl bg-white p-4">
                  <div className="aspect-[9/16] bg-slate-100 rounded-2xl flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <p className="text-sm text-slate-500">Analytics View</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="rounded-3xl bg-white p-4">
                  <div className="aspect-[9/16] bg-slate-100 rounded-2xl flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <p className="text-sm text-slate-500">Expense Capture</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          <Card className="rounded-3xl border-0 shadow-lg hover:shadow-xl transition-shadow duration-300">
            <CardContent className="p-8">
              <div className="w-12 h-12 rounded-full bg-gradient-to-r from-purple-600 to-blue-600 flex items-center justify-center mb-6">
        ...
        <div className="text-center space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Button
              variant="outline"
              size="lg"
              className="rounded-full border-2 border-purple-200 hover:bg-purple-50 px-8 py-3 text-lg w-full sm:w-auto"
              onClick={handleLogin}
            >
              Login to Account
            </Button>
